...
<body>
<h1>RESERVAS - Leer lineas de IBEROSERVICE - PLAYA -  Archivo Excel</h1>
...
$objPHPExcel = $objReader->load('xls/Iberoservice/playa_1.xls');
...
$objWriter->save("xls/Iberoservice/LINplaya.xlsx");
