...
<body>
<h1>RESERVAS - Leer lineas de IBEROSERVICE - OASIS -  Archivo Excel</h1>
...
$objPHPExcel = $objReader->load('xls/Iberoservice/oasis_1.xls');
...
for ($i=1;$i<=$allcell;$i++){
    ...
    //VALOR DE LA EDAD
    if (($varAN<'4' and $varAN<>'' and $varM <>'E.S.' and $varM<> '35660')) {//NIÑO
...
$objWriter->save("xls/Iberoservice/LINoasis.xlsx");
