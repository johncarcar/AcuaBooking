...
<body>
<h1>RESERVAS - Leer lineas de IBS - MARISMAS -  Archivo Excel</h1>
...
for ($i=1;$i<=$allcell;$i++){
    ...
    if($varAN>='60'){//SE FACTURA COMO ADULTO. CUANDO SE CREO AL PRINCIPIO SE CALCULO COMO SENIOR
        $varDesc=$descArtA;
        $varArt=$codArtA;
        $varPrec=$codPrecA; 
    }
