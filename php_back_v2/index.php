...
<html>
    ...
    <body>
        ...
        <div>
            <form action="JET2Cabecera.php" method="GET" target="_blank">
                <h2>JET2</h2>
        ...
        <div>
            <form action="PLACabecera.php" method="GET" target="_blank" >
                <h2>PLAYAPARK</h2>
                <h3>Introduzca el Nº de Albaran para generar las Cabeceras y Albaranes</h3>
                <input type="text" name="numero" value="<?php echo $var1?>">
                <input type="submit" value="Enviar"><br/><p/>
        ...
        <div>
            <form action="OASCabecera.php" method="GET" target="_blank">
                <h2>OASIS</h2>
                <h3>Introduzca el Nº de Albaran para generar las Cabeceras y Albaranes</h3>
                <input type="text" name="numero" value="<?php echo $var1?>">
                <input type="submit" value="Enviar"><br/><p/>
        ...
        <div>
            <form action="MARCabecera.php" method="GET" target="_blank">
                <h2>MARISMAS</h2>
                <h3>Introduzca el Nº de Albaran para generar las Cabeceras y Albaranes</h3>
                <input type="text" name="numero" value="<?php echo $var1?>">
                <input type="submit" value="Enviar"><br/><p/>
